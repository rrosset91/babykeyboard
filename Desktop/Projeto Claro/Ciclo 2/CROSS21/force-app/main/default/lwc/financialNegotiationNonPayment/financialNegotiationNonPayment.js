...
export default class FinancialNegotiationNonPayment extends NavigationMixin(LightningElement) 
{
    ...
    async fetchDetailsInvoices() 
  {
	...
	// **************** Evento Voltar ****************
    // handleVoltar() 
    // { this.dispatchEvent(new CustomEvent("backdetails", { detail: { negociationItems: this.data, comment: this.comment } })); }
    // ***********************************************

    // **************** Evento Simular ****************
    handleSimulation()
    { this.dispatchEvent(new CustomEvent("OpenConfirmarNegociacao")); }
    // ************************************************
}