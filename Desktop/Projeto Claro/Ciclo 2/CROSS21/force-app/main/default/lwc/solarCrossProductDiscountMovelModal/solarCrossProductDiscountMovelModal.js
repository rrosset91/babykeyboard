...
const columnsDiscount = [{label:'NOME', fieldName:'name', hideDefaultActions: true,sortable: true},
                        {label:'TIPO', fieldName:'offerType', hideDefaultActions: true,sortable: true},
                        {label:'NÍVEL', fieldName:'level', hideDefaultActions: true,sortable: true},
                        {label:'INICIO', fieldName:'effectiveStartDate',type: 'date-local',typeAttributes: {year:"numeric", month:"2-digit", day:"2-digit"},hideDefaultActions: true, sortable: true},
                        {label:'FIM', fieldName:'expiryDate',type: 'date-local',typeAttributes: {year:"numeric", month:"2-digit", day:"2-digit"},hideDefaultActions: true, sortable: true},
