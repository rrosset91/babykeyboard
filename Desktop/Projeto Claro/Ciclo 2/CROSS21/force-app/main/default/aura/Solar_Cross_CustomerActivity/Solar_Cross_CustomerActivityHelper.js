    ...
    getDataFromApex : function(component, event, helper) {
        ...
        action.setCallback(this, function(response) {
            ...
            if (state === "SUCCESS") {
                ...
                //Show CEM Experience if Business Unit is Movel
                if(result.BusinessUnit != undefined && (result.BusinessUnit == 'Claro' || result.BusinessUnit == 'Claro - Pré' || result.BusinessUnit == 'Claro - Pós')){
                    component.set("v.showCEMExperience",true);
                }
