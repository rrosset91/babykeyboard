({
    ...
    let sortedData = this.sortData("realDate", "desc", listData);
    component.set(componentList, sortedData);
  ...
  fillDataAccordionNewProductList: function (
    component,
    componentList,
    groupType
  ) {
  ...
  fillDataAccordionAdjustmentList: function (
    component,
    componentList,
    groupType
  ) {
  ...
  fillDataAccordionOccurrenceList: function (
    component,
    componentList,
    groupType
  ) {
    let occurrenceData = component.get("v.occurrenceData");
		var listData = [];
  ...
  fillDataAccordionRequestFeeList: function (
    component,
    componentList,
    groupType
  ) {
	...
	findEventDetails: function (component, event) {
      ...
      requestId: event.requestID,
		...
		action.setCallback(this, function (response) {
          ...
          console.log(
            "Valor configurations -> ",
            JSON.parse(JSON.stringify(data.configurations))
          );
          console.log(
            "Valor orders -> ",
            JSON.parse(JSON.stringify(data.orders))
          );
        ...
        return;
          ...
          endDate: component.get("v.FilterEndDate"),
			...
			action.setCallback(this, function (response) {
                ...
                x.formattedDate =
                  historyDate[2] + "/" + historyDate[1] + "/" + historyDate[0];
        ...
        return;
          ...
          endDate: component.get("v.FilterEndDate"),
			...
			action.setCallback(this, function (response) {
                ...
                x.formattedDate =
                  saleDate[2] + "/" + saleDate[1] + "/" + saleDate[0];
          ...
          endDate: component.get("v.FilterEndDate"),
			...
			action.setCallback(this, function (response) {
                ...
                formattedPrevisionDate =
                  formattedPrevisionDate[0] +
                  "/" +
                  formattedPrevisionDate[1] +
                  "/" +
                  formattedPrevisionDate[2];
