({
	...
	varrerProdutos : function (component, event){
		...
		var hasFidelity = { 
			...
			mobile : component.get('v.keepMobile') ? false : atual.mobile.planMobile.fidelity.hasFidelity,
	...
	endCase : function (component, event ){
        ...
        action.setParams({
			...
			"keepMobile" : component.get('v.keepMobile')
        });
       action.setCallback(this, function(response){
            var state = response.getState();
            if (state === "SUCCESS") {
	...
	hasAgendamento : function (component, event){
	  ...
	  if(produtoAtual.movimentTv === 'Cancelamento' || produtoAtual.movimentBroadband === 'Cancelamento' || 
		 produtoAtual.movimentPhone === 'Cancelamento' || (!component.get('v.keepMobile') && produtoAtual.movimentMobile === 'Cancelamento') ){
