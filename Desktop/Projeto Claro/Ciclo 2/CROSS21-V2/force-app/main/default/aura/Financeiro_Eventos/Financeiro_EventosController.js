({
	...
	handlePeriodFilter: function (component, event, helper) {
		...
		if (selectedFilter != "CustomFilter") component.set("v.PeriodoCustomizado", false);
	...
	onClickFiltrarPeriodo: function (component, event, helper) {
		if (component.get("v.contractId") && component.get("v.operatorId")) {
			if (component.get("v.FilterEndDate") != "" && component.get("v.FilterStartDate") != "") component.set("v.PeriodoCustomizado", true);
	...
	onSortHistory: function (component, event, helper) {
		...
		if (fieldName == "formattedDate") fieldName = "realDate";
	...
	onSortAdjustments: function (component, event, helper) {
		...
		if (!allAdjustment) return;

		if (fieldName == "formattedDate") fieldName = "realDate";

		if (fieldName == "formattedAmount") fieldName = "realValue";

		if (fieldName == "percentAdjusted") fieldName = "percentValue";
	...
	onSortRequestFees: function (component, event, helper) {
		...
		if (!allRequestFees) return;

		if (fieldName == "formattedDate") fieldName = "realDate";

		if (fieldName == "formattedAmount") fieldName = "amount";
	...
	onSortPpvs: function (component, event, helper) {
		...
		if (fieldName == "formattedPrice") fieldName = "price";
