({
    ...
    handleSaveButton: function(component, event, helper) {
        ...
        if(callGetBeforePost){
            var getDadosConta = component.get("c.getDadosConta");
            getDadosConta.setParams({recordId: component.get("v.recordId")});

            getDadosConta.setCallback(this, function (response) {
                if(helper.validarTelefoneContaContato(response))
                {    
