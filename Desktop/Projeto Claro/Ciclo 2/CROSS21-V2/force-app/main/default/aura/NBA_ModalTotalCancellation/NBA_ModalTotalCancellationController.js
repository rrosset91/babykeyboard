({
	incluirModal: function (component, event, helper) {
		component.set('v.keepMobile', component.get('v.isRetencao') && !component.get('v.isPurple') && component.get('v.produtoAtual.mobile.planMobile.label')!='NÃO POSSUI');
		...
		helper.saveClickCancelation(component, event);
