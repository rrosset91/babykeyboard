({
	...
	afterMessage: function (component) {
		...
		console.log("############# Chamou o modal de Aviso ############");
		switch (afterMessage) {
			case "avisoContestacao":
                component.set("v.dialogModal", true);
                component.set("v.titleMessage", "Aviso");
                component.set("v.typeIcon", "utility:warning");
                component.set("v.typeVariant", "warning");
                component.set("v.textButton2", "Fechar e ir para ficha financeira");
                component.set("v.message", $A.get("$Label.c.modalAvisoContestacao"));
				component.set("v.afterMessage", "clickNextCase4");
				component.find("modalMessage").open();
				break;
