({
	...
	filterBy: function (component, event, helper) {
		...
		var newListOffers = listOffersToFilter.filter(function (offer) {
			...
			var nameMV = offer.nboMobile !== null && offer.nboMobile.length > 0 && offer.nboMobile[0].catalogName ? offer.nboMobile[0].catalogName : null;
			...
			return ((offer.profile === profile || !profile) && (offerType || !type) && hasPoint &&
				hasNameTv && (offer.actionTv === movimentTV || !movimentTV) && 
				hasNameBL && (offer.actionBroadband === movimentVirtua || !movimentVirtua) &&
				hasNameMV && (offer.actionMobile === movimentMobile || !movimentMobile) &&
				hasNameFN && (offer.actionPhone === movimentPhone || !movimentPhone));
		});
