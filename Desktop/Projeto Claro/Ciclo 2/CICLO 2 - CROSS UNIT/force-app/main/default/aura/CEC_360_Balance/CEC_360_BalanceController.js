({
    doInit : function(component, event, helper) {
        ...
        helper.showDeviceButton(component,helper);
        helper.showAdditionalButton(component,helper);
    },
    ...
    openModal : function(component, event, helper) {
        ...
        component.set("v.showModalExtratos", true);
    ...
    closeModal : function(component, event, helper) {
        component.set("v.dataStartValue", null);
        component.set("v.dataEndValue", null);
        component.set("v.showSpinner", false);
        component.set("v.showModalExtratos", false);
        component.set("v.showTable", false);
        component.set('v.dataTransactions', null);
        component.set('v.paginationList', null);
        component.set("v.tipo",null);
        component.set("v.subTipo",null);
    },
    ...
    handleSaldoPrincipal : function(component, event, helper) {
        helper.loadBalance(component, event, helper);
    },
    
    handleSaldosAcumuladores : function(component, event, helper) {
        helper.loadOtherBalances(component, event, helper);
    },
    
    handleSaldosPromocionais : function(component, event, helper) {
        helper.loadOtherBalancesPromotional(component, event, helper);
    },
    
    openOtherBalances : function(component, event, helper) {
        helper.loadBalance(component, event, helper);
        component.set("v.showModalSaldos", true);
    },
    
    closeOtherBalances : function(component, event, helper) {
        component.set("v.showModalSaldos", false);
        component.set("v.dataAccumulators", '');
        component.set("v.dataPromotional", '');
    },

    handleShowModal: function(component, event, helper) {
        helper.showModalDevice(component,event,helper);
    }
})