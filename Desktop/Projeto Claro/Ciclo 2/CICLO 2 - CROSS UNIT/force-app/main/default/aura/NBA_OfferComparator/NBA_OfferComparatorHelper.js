({
	...
	recalculateCurrentProduct: function(component) {
		...
		var mobileEmpty = {
			...
			"feeProducts": [],
			"isComboMulti": false,
			"listaDependentesMobile": [],
			"listaDependentesMobileSelected": [],
			"lstAdditionals": [],
			"msisdn": "",
			"name": "",
			"netsalesProductName": "",
			"numeroDependentesDados": 0,
			"numeroDependentesDadosOriginal": 0,
			"numeroDependentesDadosSelected": 0,
			"numeroDependentesVozDados": 0,
			"numeroDependentesVozDadosOriginal": 0,
			"numeroDependentesVozDadosSelected": 0,
			"numeroMaxDep": 0,
			"planMobile": {
				"fidelity": {
					"hasFidelity": false,
			...
			"titularMobile": {
				...
				"feeProducts": [],
				"fidelity": false,
				"listBeneficiosDoPlano": [],
				"listProdutosAdicionais": [],
				"nameLegacy": "",
				"nomePlano": "",
				"numeroTelefone": "",
				"operadora": "",
			...
			"totalDados": 0,
			"totalDadosOriginal": 0,
			"totalDadosSelected": 0,
			"totalDependentes": 0,
			"totalDependentesSelected": 0,
			"totalVozDados": 0,
			"totalVozDadosOriginal": 0,
			"totalVozDadosSelected": 0
		};
