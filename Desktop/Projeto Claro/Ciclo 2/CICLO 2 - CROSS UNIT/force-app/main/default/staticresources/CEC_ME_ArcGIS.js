vlocity.cardframework.registerModule.service('testServiceME', [function() {
    this.getStatesBR = function() {
        return [
            ["AC", "Acre"],
            ["AL", "Alagoas"],
            ["AP", "Amapá"],
    ...
    this.getStreetTitleAbrev = function() {
        return [
            ["ACD", "Acadêmico"],
            ["ADV", "Advogado"],
            ["ALM", "Almirante"],
